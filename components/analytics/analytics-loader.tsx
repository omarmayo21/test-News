...
export function AnalyticsLoader({
  ...
  useEffect(() => {
    // If consent is disabled, load scripts immediately (but deferred after hydration)
    ...
    window.addEventListener("nexus_cookie_consent_change", handleConsentChange);
    return () => window.removeEventListener("nexus_cookie_consent_change", handleConsentChange);
  }, [cookieConsentEnabled]);
